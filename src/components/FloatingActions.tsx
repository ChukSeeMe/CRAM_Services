        ...
        {isVisible && (
          <div className="relative flex flex-col items-start gap-4">
            ...
            <motion.button
              ...
              className="w-14 h-14 bg-[#D18F08] rounded-full flex items-center justify-center shadow-[0_10px_40px_rgba(209,143,8,0.5)] border border-white/20 z-[91]"
              aria-label={isOpen ? 'Close menu' : 'Open contact options'}
            >
