  ...
  return (
    <div className="min-h-screen flex flex-col pt-10">
      ...
      <section className="relative pt-48 pb-24 px-6 overflow-hidden flex-grow flex flex-col items-center justify-center min-h-screen">
        {/* Decorative blobs — hidden on mobile to prevent GPU overflow / black screen */}
          ...
          {services.map((service) => (
            <motion.div key={service.id} variants={itemVariants}>
              <div
                ...
                className="group relative min-h-[500px] flex flex-col justify-end rounded-[2.5rem] overflow-hidden glass-panel glass-panel-hover cursor-pointer"
              >
                {service.href !== '#' ? (
